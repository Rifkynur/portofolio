  ...
  return (
    <div>
      ...
      <p className="text-xs w-full mt-5 text-slate-700 md:text-lg md:w-full lg:w-10/12 dark:text-slate-300">
        I am a it anthusiast with passion fro building beautiful and user friendly website.I am exited to put my skill to use professional setting.i am quick learning and team player, and i am confident than i can be a valueable asset to
